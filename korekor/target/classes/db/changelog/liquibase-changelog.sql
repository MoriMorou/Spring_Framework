...
-- CONSTRAINT `fk_good_brand_goods` FOREIGN KEY (`good_brand_id`) REFERENCES `good_brand`(`id`),
-- CONSTRAINT `fk_good_size_goods` FOREIGN KEY (`good_size_id`) REFERENCES `good_size`(`id`),
-- CONSTRAINT `fk_good_colour_goods` FOREIGN KEY (`good_colour_id`) REFERENCES `good_colour`(`id`)
-- );
--
...
-- INSERT INTO `good_brand` VALUES (1, 'Michael Kors'), (2, 'Jeffrey Campbell'), (3, 'Dior');
